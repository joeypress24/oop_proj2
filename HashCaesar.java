/**
The purpose of the hashCaesar class is to extend the Caesar class to increase
the functionality by adding a hashing option.
@author Press, Joseph
*/
public class HashCaesar extends Caesar implements Hasher {
...
// TEST MAIN (used mostly to test shiftLeft)
  public static void main(String[] args)
  {
    // System.out.println("x: " + this.x);
    // shiftLeft(1);
    // System.out.println("left shift of x: " + x);
    String str = "GO_NAVY_2018^mid";
    int len = str.length();
